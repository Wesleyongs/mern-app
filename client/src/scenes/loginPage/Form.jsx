...
const Form = () => {
  ...
  const login = async (values, onSubmitProps) => {
    const loggedInResponse = await fetch(config.app.url+"auth/login", {
      method: "POST",
              ...
              <>
                ...
                >
                  <Dropzone
                    ...
                    onDrop={
                      (acceptedFiles) =>
                        setFieldValue("picture", acceptedFiles[0]) // call back function to set field value
                    }
                  >
